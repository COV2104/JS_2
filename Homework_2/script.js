...
const elementWithMenuClass = document.querySelector(".menu");
elementWithMenuClass.classList.remove("dropdown-menu");
...
const elementWithAriaLabelledby = document.querySelector(
